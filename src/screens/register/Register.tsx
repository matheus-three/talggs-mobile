...
const Register = () => {
  ...
  const ConvertValues = () => {
    ...
    dbh.collection("user-mobile").add(parseado);
    console.log("DBH")
    console.log(dbh)
  };
    ...
    >
      <ScrollView>
        <View style={{ alignItems: "center" }}>
          ...
          />
          {!validCpf ? (
            <Text style={Style.error}>Você deve inserir um CPF válido</Text>
          ) : null}
          ...
          <TextInput placeholder="Rua" style={Style.input} value={Logradouro} />
          <TextInput placeholder="Bairro" style={Style.input} value={Bairro} />
          ...
          />
          {!validEmail ? (
            <Text style={Style.error}>Você deve inserir um E-mail válido</Text>
          ) : null}
